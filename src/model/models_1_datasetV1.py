...
skf = KFold(shuffle=True, n_splits=10, random_state=260681)
...
estimators = {RandomForestRegressor(n_estimators=500, n_jobs=12, random_state=42): 'RFR1' + BUILD_NAME,
              ExtraTreesRegressor(n_estimators=500, n_jobs=12, random_state=42): 'ETR1' + BUILD_NAME,
